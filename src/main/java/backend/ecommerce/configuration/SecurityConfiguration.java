package backend.ecommerce.configuration;

import static backend.ecommerce.constant.SecurityConstant.PUBLIC_URLS;
...
import backend.ecommerce.filter.JwtAuthorizationFilter;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    private JwtAuthorizationFilter jwAuthorizationFilter;
    ...
    @Autowired
    public SecurityConfiguration(JwtAuthorizationFilter jwAuthorizationFilter,
